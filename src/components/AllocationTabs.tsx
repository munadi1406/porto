...
const COLORS = [
    "#3b82f6", "hsl(var(--success))", "#f59e0b", "hsl(var(--destructive))",
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
            ...
            <div className="p-4 sm:p-6 pb-0">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        <h3 className="text-base sm:text-lg font-bold text-foreground">Portfolio Allocation</h3>
                        <p className="text-xs text-muted-foreground">Distribusi aset portfolio</p>
                    </div>
                </div>
            ...
            <div className="p-4 sm:p-6 pt-4">
                {activeTab === "stock" ? (
                    ...
                    <div>
                        {sectorsLoading && (
                            <div className="text-center text-sm text-muted-foreground mb-4">Loading sectors...</div>
                        )}
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center justify-between mb-1">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className="text-xs text-muted-foreground">({sector.stockCount})</span>
                                                                </div>
